...
from .views import RandomFoodAPIView,RandomResAPIView,AllTypeFoodApiView,ResDetailApiView,ResApiView,FoodApiView,FoodByTypeApiView,TypeFoodApiView,SearchFoodApiView
urlpatterns = [
